...
```yaml
  name: Ami
  alias: Anna Mátyás
  location: Hungarian from Transylvania
  path:
    - AdTech Operations
    - Digital Analytics
    ...
    - Blue Team / SOC L1
  current_focus:
    - SOC L1 fundamentals (alerts, logs, triage)
    - Home lab: Linux + Windows + SIEM
...
<img src="https://img.shields.io/badge/Python%203-Codecademy-3776AB?style=for-the-badge&logo=python&logoColor=white" alt="Python 3 Codecademy"/>
<br/><strong>Python 3</strong><br/>
<sub>2025</sub>
</td>

<!-- Diploma in Python Programming – Alison -->
<td align="center" width="25%">
<img src="https://img.shields.io/badge/Python%20Diploma-Alison-0A66C2?style=for-the-badge&logo=python&logoColor=white" alt="Python Diploma Alison"/>
<br/><strong>Diploma in Python Programming</strong><br/>
<sub>2025</sub>
</td>
...
<br/><strong>Professional Diploma in Computer Science</strong><br/>
<sub>2009</sub>
</td>
